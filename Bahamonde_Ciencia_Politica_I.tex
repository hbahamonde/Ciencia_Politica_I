...
\begin{enumerate}
		...
		\item {\bf \underline{Reg\'imenes Pol\'iticos: Democracia y Autoritarismo}}
			\begin{enumerate}
				\item {\bf ¿Qu\'e es la Democracia?: consenso y ``Westminster''}.
					\begin{enumerate}
					...
					\end{enumerate}
				\item {\bf ¿Qu\'e es la Democracia?: cuestiones conceptuales}.
					\begin{enumerate}
					...
					\end{enumerate}
				\item {\bf ¿C\'omo se mide la Democracia?: binario versus continuo}.
					\begin{enumerate}
					...
					\end{enumerate}
				\item {\bf ¿Qu\'e Causa la Democracia?: pre-requisitos sociales versus pre-requisitos econ\'omicos}.  
					\begin{enumerate}
						\item Przeworksi, Adam and Fernando Limongi. 1997. \href{https://github.com/hbahamonde/Ciencia_Politica_I/raw/master/Readings/Przeworksi_Limongi.pdf}{``Modernization: Theories and Facts.''} \emph{World Politics}, 49(1): 155-183. 
					...
					\end{enumerate}
				\item {\bf ¿Qu\'e Causa la Democracia?: democracia y redistribuci\'on econ\'omica}.  
					\begin{enumerate}
					...
					\end{enumerate}
				\item {\bf Partidos Pol\'iticos: formaci\'on y competencia ideol\'ogica}.
					\begin{enumerate}
					...
					\end{enumerate}
				\item {\bf Clientelismo: ¿Una falla democr\'atica?} 
					\begin{enumerate}
					...
					\end{enumerate}
				\item {\bf Sistemas Electorales: or\'igenes y consecuencias}.
					\begin{enumerate}
					...
					\end{enumerate}
				\item {\bf Parlamentarismo y Presidencialismo: ventajas y desventajas de cada uno}.
					\begin{enumerate}
						\item Linz, Juan. 1994. \href{https://github.com/hbahamonde/Ciencia_Politica_I/raw/master/Readings/Linz.pdf}{Presidential or Parliamentary Democracy: Does it Make a Difference?} In \emph{The Failure of Presidential Democracy: The Case of Latin America}, Juan Linz and Arturo Valenzuela (Eds.), 3–90. Baltimore: Johns Hopkins University Press % Parla
